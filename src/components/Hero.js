    ...
    <div className="text-white flex flex-col pt-40 pb-40 w-9/12 m-auto">
      ...
      <div className="flex w-5/6 m-auto justify-center font-serif">
        <Link className="font-serif" to={"/plant"}>
          <button className="bg-slate-50 font-alice m-5 tracking-wide rounded-md rounded-br-none border-[3px] border-slate-200 border-solid p-2 px-6 text-stone-800 font-bold">
            Plant your first tree.
          </button>
        </Link>
        <button className="rounded-lg font-alice m-5 tracking-wide rounded-br-none border-[3px] border-slate-200 border-solid p-2 px-10">
          Learn More.
        </button>
      </div>
    </div>
