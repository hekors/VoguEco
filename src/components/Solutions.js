...
function SolutionCard(props) {
  return (
    <div className="flex w-9/12 m-auto bg-slate-50 rounded-2xl shadow-2xl justify-around my-10 hover:scale-105">
      ...
      <div className="w-6/12 flex flex-col justify-center">
        ...
        <p className="text-green-800">{props.desc}</p>
        <button className="w-5/12 my-5 rounded-lg font-alice tracking-wide rounded-br-none border-2 bg-greenishtxt shadow-lg text-slate-50 font-medium p-2 hover:bg-greenish hover:font-medium">
          {props.but}
        </button>
      </div>
    </div>
